...
quietly set PROJECT_DIR "C:/Users/Administrator/Desktop/74HC153/HC153"
...
vlog -vlog01compat -work postlayout "${PROJECT_DIR}/designer/impl1/HC153_ba.v"
vlog "+incdir+${PROJECT_DIR}/stimulus" -vlog01compat -work postlayout "${PROJECT_DIR}/stimulus/testbench.v"

vsim -L proasic3 -L postlayout  -t 1ps -sdfmax /ul=${PROJECT_DIR}/designer/impl1/HC153_ba.sdf postlayout.testbench
add wave /testbench/*
run 1000ns
